...
export default function Books() {
    ...
    return (
        <div className='flex justify-center flex-col mx-40'>
            ...
            <h1 className='font-extrabold text-center text-lg text-slate-500'>{params.nombreParam}</h1>
            {libros.length === 0 ? (<p>No hay libros disponibles</p>) : (
                    <div className=''>
                        {libros.filter(libro => libro.book.ISBN === params.nombreParam) // Aplicar el filtro
                        .map(libro => (
